...
from backend.torsion.scan_preprocess import (
...
# â”€â”€ sort_scan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ deduplicate_endpoint â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestDeduplicateEndpoint:
    ...
    def test_near_duplicate_within_tol(self):
        # phi[-1] = phi[0] + period - 0.01 â†’ within default tol 0.05
        phi = np.array([0.0, 1.0, 2.0, 3.0, 6.27])  # 6.27 â‰ˆ 2Ï€ - 0.013
        e = np.zeros(5)
        _, _, removed = deduplicate_endpoint(phi, e, period_rad=2 * np.pi, tol_rad=0.05)
        assert removed is True

    def test_boundary_outside_tol(self):
        phi = np.array([0.0, 1.0, 2.0, 3.0, 6.0])  # 6.0 far from 2Ï€
        e = np.zeros(5)
        _, _, removed = deduplicate_endpoint(phi, e, period_rad=2 * np.pi, tol_rad=0.05)
        assert removed is False
    ...
    def test_threefold_period(self):
        # Methanol-like 3-fold scan: endpoint at 0 + 2Ï€/3
        period = 2 * np.pi / 3
...
# â”€â”€ extend_by_symmetry â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ preprocess_scan â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestPreprocessScan:
    def test_default_sorts_and_deduplicates(self):
        ...
        # Should be sorted
        assert np.all(np.diff(phi2) > 0)
        # duplicate endpoint 2Ï€ â‰ˆ 0 + period â†’ removed
