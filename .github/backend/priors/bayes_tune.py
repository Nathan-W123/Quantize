...
def _surrogate_relax_objective(
    ...
    from backend.conformers.geometryguess import guess_geometry
    ...
    from backend.conformers.geometryguess import _bond_length_guess  # pylint: disable=import-outside-toplevel
